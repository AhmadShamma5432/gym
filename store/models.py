...
from .validations import validate_quantity
...
class Product(models.Model):
    ...
    why_should_i_buy_it = models.TextField()
    how_should_i_take_it = models.TextField()
...
class Profile(models.Model):
    ...
    fitness_goal = models.TextField(null=True, blank=True)  # e.g., "Lose fat", "Build muscle"
